<template>
  <div>
    <header class="bg-indigo-500">
      <nav class="flex  justify-between items-center mx-auto w-[92%] ">
        <!--<div>
          <img src="https://cdn-icons-png.flaticon.com/512/5968/5968204.png" alt="navImg" class="w-16">
        </div>-->
        <div class="">
          <ul class="flex md:flex-row justify-between items-center gap-[4vw] mx-auto">
            <li v-for="data in datas" :key="data.id" class="hover:text-gray-500 cursor-pointer">{{ data.content }}</li>
          </ul>
        </div>
        <div>
 ...
 <script setup>
  ...
  const datas = [
    ...
    { id: 2, href: '#', content: 'Dashboard' },
    { id: 3, href: '#', content: 'info' },
  ]
...
<div class="min-h-full">
          ...
          <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
              <div class="ml-4 flex items-center md:ml-6">
                <button type="button" class="relative rounded-full bg-gray-800 p-1 text-gray-800
      ...
      <main class="justify-center mt-6">
        <div class="mx-auto  py-6 sm:px-6 lg:px-8 text-white  bg-gray-100">
             <slot></slot>
        </div>
      </main>
    </div> 
